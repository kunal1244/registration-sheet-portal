...
<div class="span3" style="margin-left: 40%;">
   ...
   <form method="POST" action="newRegUpdate.php">
      <label style="font-size: 17px;">First Name</label>
      <input style="width: 350px; height: 35px;" type="text" name="firstname" class="span3">
      
      <label style="font-size: 17px;">Last Name</label>
      <input style="width: 350px; height: 35px;" type="text" name="lastname" class="span3">
